...
class PatientListSerializer(serializers.ModelSerializer):
    ...
    def get_wilaya_name(self, obj):
        ...
        return obj.wilaya_text or None
    ...
    def get_dernier_cancer(self, obj):
        ...
        return {
            'id':              cancer.id,
            'organe':          cancer.cancer_type.name if cancer.cancer_type else None,
            'stade':           cancer.stade_clinique or cancer.stade_pathologique or None,
            'tnm':             cancer.tnm or '',
            'grade':           cancer.grade or '',
            'date_diagnostic': str(cancer.date_diagnostic) if cancer.date_diagnostic else None,
...
class PatientDetailSerializer(serializers.ModelSerializer):
    ...
    full_name     = serializers.ReadOnlyField()
    commune_name  = serializers.CharField(source='commune.name', read_only=True)
    wilaya_name   = serializers.SerializerMethodField()   # commune.wilaya.name OU wilaya_text
    hospital_name = serializers.SerializerMethodField()   # null-safe
    medecin_nom   = serializers.SerializerMethodField()
    ...
    wilaya_text   = serializers.CharField(required=False, allow_blank=True)  # read + write
    ...
    class Meta:
        ...
        fields = [
            ...
            'situation_familiale', 'profession',
            'phone', 'email', 'adresse',
            'commune', 'commune_name', 'wilaya_name', 'wilaya_text',
            'hospital', 'hospital_name',
            'couverture_sociale',
            'created_by', 'medecin_nom',
