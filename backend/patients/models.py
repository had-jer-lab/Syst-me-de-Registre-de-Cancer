...
class Patient(models.Model):
    ...
    wilaya_text         = models.CharField(max_length=100, blank=True)   # ← texte libre si pas de commune FK
...
# ─── QR Code Formulaire Patient ───────────────────────────────────────────────

class PatientFormToken(models.Model):
    """Lien unique par patient → formulaire public via QR code (sans login)."""
...
class PatientFormSubmission(models.Model):
    """Enregistre chaque soumission du formulaire par le patient."""
